...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="flex items-center justify-between w-full px-6 py-4  bg-transparent">

            
        <div className="justify-start ">
          <a  className="flex gap-5" title="Start Of Web Page"><img src={myLogo} alt="My Logo" className="w-10 h-10" /><p className="text-4xl">Housify</p></a>
        </div>

       
        <div className="flex absolute left-1/2 transform -translate-x-1/2  border border-[rgb(255,166,83)] rounded-full py-1.2 shadow-lg ">
          ...
          <Link to="/predict" className="text-2xl border border-transparent bg-transparent rounded-full py-1 px-3 hover:bg-[rgb(250,213,178)]  transition-all duration-800 hover:shadow-lg " title="Predict">Predict</Link>
          <Link to="/mortgage" className="text-2xl border border-transparent bg-transparent rounded-full py-1 px-3 hover:bg-[rgb(250,213,178)]  transition-all duration-800 hover:shadow-lg " title="Mortgage calculator">Mortgage calculator</Link>
        </div>
