...
//Import React font awsome icons(github,linkedin,user) library 
  ...
  return (
    <>
      <nav className="flex items-center justify-between w-full px-6 py-4  bg-transparent font-raleway ">
        ...
        {/*mini navbar, links to different pages*/}
        <div className="flex absolute left-1/2 transform -translate-x-1/2  border border-[rgb(255,166,83)] rounded-full py-1.2 shadow-lg font-[400]">
          ...
          <Link to="/mortgageCalc" className="text-2xl border border-transparent bg-transparent rounded-full py-1 px-3 hover:bg-[rgb(255,195,139)]  transition-all duration-800 hover:shadow-lg " title="Mortgage calculator">Mortgage calculator</Link>
        </div>
        
        {/*buttons link to github ,linkedin,and personal website*/}
